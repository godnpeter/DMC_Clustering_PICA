...
class Explorer:
    ...
    def __init__(self, session, agents=None, **params):
        ...
        self.obs_cluster_num = 32
        self.action_cluster_num = 8
    ...
    def make_FSM(self, counter, obs_cluster_num, action_cluster_num):

        transition_list = list(counter.keys())
        ...
        table.column_headers = ["_", "0", "1", "2", "3"]
        for i in range(action_cluster_num):
            table.append_row([i, transition_table[i][0], transition_table[i][1],  transition_table[i][2],  transition_table[i][3]])
    ...
    def report_rewards(self, infos):
        ...
        if '/episode/r' in infos.keys():
            ...
            self.timestep = self.timestep +1
                ...
                #self.make_FSM(transition_counter, self.obs_cluster_num, self.action_cluster_num)
